 ...
 *
 * `hasErr` = true when the phone number does not have a valid format.
 ...
 * @returns {{hasErr: boolean, noErr: boolean, errMsg: (string | null)}} The validation results.
 * @example
 *
...
module.exports = function isPhone(
  ...
  if (typeof phone !== "string") throw Error("Argument must be type string");
